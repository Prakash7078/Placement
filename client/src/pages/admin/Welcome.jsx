    ...
    <div>
        ...
        <div className='pt-10 lg:pl-80'>
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mx-auto gap-3 lg:gap-5 px-10'>
            <div className="box cursor-pointer transition ease-in-out delay-150 md:hover:-translate-y-1 md:hover:scale-105 flex justify-center items-center flex-col bg-blue-200 h-48 rounded-lg lg:h-40 ">
